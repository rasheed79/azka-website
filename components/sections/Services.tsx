            ...
            return (
              <StaggerItem key={slug}>
                <Link
                  ...
                  className="group block p-6 rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-green-500/40 hover:bg-slate-800/80 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/5"
                >
                  ...
                  <h3 className="text-white font-semibold text-base mb-2 group-hover:text-green-300 transition-colors leading-snug">
                    {name}
                  </h3>
